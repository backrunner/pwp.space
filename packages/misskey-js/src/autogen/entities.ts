...
export type DriveFilesGetProxyUrlRequest = operations['drive___files___get-proxy-url']['requestBody']['content']['application/json'];
export type DriveFilesGetProxyUrlResponse = operations['drive___files___get-proxy-url']['responses']['200']['content']['application/json'];
