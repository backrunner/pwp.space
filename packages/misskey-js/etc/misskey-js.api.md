...
// @public (undocumented)
type DriveFilesGetProxyUrlRequest = operations['drive___files___get-proxy-url']['requestBody']['content']['application/json'];

// @public (undocumented)
type DriveFilesGetProxyUrlResponse = operations['drive___files___get-proxy-url']['responses']['200']['content']['application/json'];
