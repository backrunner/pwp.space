...
export const paramDef = {
	...
	properties: {
		...
		state: {
			type: 'string',
			enum: ['all', 'alive', 'available', 'admin', 'moderator', 'adminOrModerator', 'suspended', 'pendingApproval', 'approved'],
			default: 'all',
			description: '`approved` is a deprecated alias for `pendingApproval`.',
		},
